...
export const buttonVariants = cva(
  [
    'cursor-pointer font-medium inline-flex items-center gap-1.5 justify-center whitespace-nowrap rounded-sm text-sm ring-offset-background transition-all duration-150 ease-out no-underline',
    'hover:opacity-90 active:opacity-100',
    'active:scale-[0.98] motion-reduce:transform-none motion-reduce:active:scale-100',
  ...
  ],
  {
    variants: {
      variant: {
        ...
        link:
          'text-primary-foreground underline-offset-4 hover:underline px-0! py-0! h-auto! underline active:scale-100 active:opacity-75',
        unstyled: 'active:scale-100',
      },
      size: {
