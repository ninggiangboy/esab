...
public enum AccountError implements DomainError {
    ...
    EMAIL_ALREADY_EXISTS("Email is already registered", DomainErrorType.DUPLICATE),
    ...
    EMAIL_ALREADY_VERIFIED("Email has already been verified", DomainErrorType.DUPLICATE),
    ...
    OAUTH_EMAIL_CONFLICT("Email is already linked to another account", DomainErrorType.DUPLICATE),
